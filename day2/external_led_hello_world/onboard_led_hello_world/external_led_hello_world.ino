// -----------------------------------------------------------------------------
// Script   : external_led_hello_world.ino
// Engineer : Christian Westbrook
// Abstract : This script causes an external LED to repeat the message 
//            'HELLO WORLD' using Morse code.
// -----------------------------------------------------------------------------
...
//            or reset. This function initializes a pin for use as an output device.
// -----------------------------------------------------------------------------
void setup() {
